...
let ctrls = {
    ...
    seafloor:"https://media.socastsrm.com/wordpress/wp-content/blogs.dir/1257/files/2019/05/2019-05-13-Taco-Bell-Artwork.jpg",
    clr1: {r:61, g:58, b:255}, //color 1
    clr2:{ r:172, g:255, b:86}, //color 2
    d_range: {min: 1, max:30}, //range of sphere diameters
...
function triggerNote(note) {
    ...
    var sphere = BABYLON.MeshBuilder.CreateTorusKnot("sphere", { p: random(ctrls.d_range.min, ctrls.d_range.max), q: random(ctrls.d_range.min, ctrls.d_range.max), radialSegments: 32 }, scene);
